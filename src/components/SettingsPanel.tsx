...
export function SettingsPanel({ settings, onUpdate, isOpen, onClose }: SettingsPanelProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/20 dark:bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-md m-4 p-6">
              ...
              <div className="space-y-3 pl-4">
                ...
                <label className="flex items-center space-x-3">
                  <input
                    ...
                    className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                  />
                  <span className="text-sm text-gray-700 dark:text-gray-300">Typing Sounds</span>
                </label>
              </div>
            )}
          </div>
